...
$(document).ready(function(){
	...
	//Homepage banner
	$(".banner-images div").css('opacity',0);
	$(".banner-images div:first-child").css('opacity',1);
	setInterval(function(){
		$(".banner-images div:first-child").animate({opacity: 0}, 500,function(){
			$(this).next().animate({opacity: 1}, 500)
			$(this).detach().appendTo(".banner-images")
		})
	},6000)	

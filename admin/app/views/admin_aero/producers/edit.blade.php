...
@section('main')
	...
	<div class="row-fluid">
		...
		<div class="span8 clearfix">
			...
			<h3>Producers (aero) - Edit Producer - <span>{{ $producer->first_name .' '. $producer->last_name }}</span></h3>


			{{ Form::model($producer, array('method' => 'put', 'files' => true, 'route' => array('aero-admin.producers.update', $producer->id))) }}
				...
				<div class="form-actions">
					...
					<a href="{{ URL::route('aero-admin.producers.index') }}" class="btn btn-info">BACK</a>
				</div>

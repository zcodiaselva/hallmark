...
@section('main')
	...
	<div class="row-fluid">
		...
		<div class="span8 clearfix">
			...
			<h3>Forms (aero) - {{ $category->name }} - <span>{{ $form->name }}</span></h3>


			{{ Form::model($form, array('method' => 'put', 'files' => true, 'route' => array('aero-admin.forms-category.forms.update', $category->id, $form->id))) }}
				...
				<div class="control-group">
					...
					@if ($form->pdf)
						<a href="{{ URL::to('aero-admin/download-form/' . $form->pdf) }}">Download PDF</a>
					@endif

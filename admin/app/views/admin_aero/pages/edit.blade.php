...
@section('main')
	...
	<div class="row-fluid">
		...
		<div class="span8 clearfix">
			...
			<h3>Pages (aero) - Edit Page - <span>{{ $page->category->name }} - {{ $page->name }}</span></h3>


			{{ Form::model($page, array('method' => 'put', 'files' => true, 'route' => array('aero-admin.pages.update', $page->id))) }}
				...
				@if ($page->has_image2)
					<div class="control-group">
						...
						@if ($page->image2)
						<img src="{{ URL::asset('uploads/aero/page/'.$page->image2) }}">
						@endif
				...
				@if ($page->has_image3)
					<div class="control-group">
						...
						@if ($page->image3)
						<img src="{{ URL::asset('uploads/aero/page/'.$page->image3) }}">
						@endif
				...
				@if ($page->has_image4)
					<div class="control-group">
						...
						@if ($page->image4)
						<img src="{{ URL::asset('uploads/aero/page/'.$page->image4) }}">
						@endif
				...
				@if ($page->has_image5)
					<div class="control-group">
						...
						@if ($page->image5)
						<img src="{{ URL::asset('uploads/aero/page/'.$page->image5) }}">
						@endif

...
@section('main')
	...
	<div class="row-fluid">
		...
		<div class="span8 clearfix">
			...
			<h3>Pages (Pro) - Edit Page - <span>{{ $page->category->name }} - {{ $page->name }}</span></h3>


			{{ Form::model($page, array('method' => 'put', 'files' => true, 'route' => array('pro-admin.pages.update', $page->id))) }}
				...
				<div class="control-group">
					...
					<div class="controls">
						{{ Form::text('slug', null, array('readonly' => 'readonly')) }}
					</div>
				</div>
				...
				@if ($page->has_body3)
					<div class="control-group">
						<div class="controls">
							{{ Form::textarea('temp_body3', null, array('class' => 'ckeditor')) }}
						</div>
					</div>
				@endif
				...
				@if ($page->has_image1)
					<div class="control-group">
						...
						@if ($page->image1)
						<img src="{{ URL::asset('uploads/pro/page/'.$page->image1) }}">
						@endif
				...
				@if ($page->has_image2)
					<div class="control-group">
						...
						@if ($page->image2)
						<img src="{{ URL::asset('uploads/pro/page/'.$page->image2) }}">
						@endif
				...
				@if ($page->has_image3)
					<div class="control-group">
						...
						@if ($page->image3)
						<img src="{{ URL::asset('uploads/pro/page/'.$page->image3) }}">
						@endif
				...
				@if ($page->has_image4)
					<div class="control-group">
						...
						@if ($page->image4)
						<img src="{{ URL::asset('uploads/pro/page/'.$page->image4) }}">
						@endif
				...
				@if ($page->has_image5)
					<div class="control-group">
						...
						@if ($page->image5)
						<img src="{{ URL::asset('uploads/pro/page/'.$page->image5) }}">
						@endif
				...
				<div class="form-actions">
					...
					<a href="{{ URL::route('pro-admin.pages.index') }}" class="btn btn-info">BACK</a>
				</div>

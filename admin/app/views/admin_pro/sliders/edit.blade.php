...
@section('main')
	...
	<div class="row-fluid">
		...
		<div class="span8 clearfix">
			...
			<h3>Slider (Pro) - Edit Image - <span>{{ $slider->title }}</span></h3>


			{{ Form::model($slider, array('method' => 'put', 'files' => true, 'route' => array('pro-admin.sliders.update', $slider->id))) }}
				...
				<div class="control-group">
					...
					@if ($slider->image)
						<img src="{{ URL::asset('uploads/pro/slider/'.$slider->image) }}">
					@endif

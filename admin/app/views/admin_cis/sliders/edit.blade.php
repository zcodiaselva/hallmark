...
@section('main')
	...
	<div class="row-fluid">
		...
		<div class="span8 clearfix">
			...
			<h3>Slider (cis) - Edit Image - <span>{{ $slider->title }}</span></h3>


			{{ Form::model($slider, array('method' => 'put', 'files' => true, 'route' => array('cis-admin.sliders.update', $slider->id))) }}
				...
				<div class="control-group">
					...
					@if ($slider->image)
						<img src="{{ URL::asset('uploads/cis/slider/'.$slider->image) }}">
					@endif
				...
				<div class="form-actions">
					...
					<a href="{{ URL::route('cis-admin.sliders.index') }}" class="btn btn-info">BACK</a>
				</div>

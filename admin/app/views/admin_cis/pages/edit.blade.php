			...
			{{ Form::model($page, array('method' => 'put', 'files' => true, 'route' => array('cis-admin.pages.update', $page->id))) }}
				...
				<div class="control-group">
                   ...
                   {{ Form::hidden('template_id', $page->template_id) }}
					...
					@if ($page->image1)
						<img src="{{ URL::asset('http://moneyquestweb.net/hm/uploads/cis/pages/'.$page->image1) }}">
					...
					@if ($page->image2)
						<img src="{{ URL::asset('http://moneyquestweb.net/public_html/hm/uploads/cis/pages/'.$page->image2) }}">

...
@section('main')
	...
	<div class="row-fluid">
		...
		<div class="span8 clearfix">
			...
			<h3>Pages (E&S) - Edit Page - <span>{{ $page->category->name }} - {{ $page->name }}</span></h3>


			{{ Form::model($page, array('method' => 'put', 'files' => true, 'route' => array('es-admin.pages.update', $page->id))) }}
				...
				@if ($page->has_image1)
					<div class="control-group">
						...
						@if ($page->image1)
						<img src="{{ URL::asset('uploads/es/page/'.$page->image1) }}">
						@endif
				...
				@if ($page->has_image2)
					<div class="control-group">
						...
						@if ($page->image2)
						<img src="{{ URL::asset('uploads/es/page/'.$page->image2) }}">
						@endif
				...
				@if ($page->has_image3)
					<div class="control-group">
						...
						@if ($page->image3)
						<img src="{{ URL::asset('uploads/es/page/'.$page->image3) }}">
						@endif
				...
				@if ($page->has_image4)
					<div class="control-group">
						...
						@if ($page->image4)
						<img src="{{ URL::asset('uploads/es/page/'.$page->image4) }}">
						@endif
				...
				@if ($page->has_image5)
					<div class="control-group">
						...
						@if ($page->image5)
						<img src="{{ URL::asset('uploads/es/page/'.$page->image5) }}">
						@endif
				...
				<div class="form-actions">
					...
					<a href="{{ URL::route('es-admin.pages.index') }}" class="btn btn-info">BACK</a>
				</div>

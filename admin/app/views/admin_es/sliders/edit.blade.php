...
@section('main')
	...
	<div class="row-fluid">
		...
		<div class="span8 clearfix">
			...
			<h3>Slider (E&S) - Edit Image - <span>{{ $slider->title }}</span></h3>


			{{ Form::model($slider, array('method' => 'put', 'files' => true, 'route' => array('es-admin.sliders.update', $slider->id))) }}
				...
				<div class="control-group">
					...
					@if ($slider->image)
						<img src="{{ URL::asset('uploads/es/slider/'.$slider->image) }}">
					@endif
				...
				<div class="form-actions">
					...
					<a href="{{ URL::route('es-admin.sliders.index') }}" class="btn btn-info">BACK</a>
				</div>

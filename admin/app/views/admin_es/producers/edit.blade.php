...
@section('main')
	...
	<div class="row-fluid">
		...
		<div class="span8 clearfix">
			...
			<h3>Producers (E&amp;S) - Edit Producer - <span>{{ $producer->first_name .' '. $producer->last_name }}</span></h3>


			{{ Form::model($producer, array('method' => 'put', 'files' => true, 'route' => array('es-admin.producers.update', $producer->id))) }}

...
class FormsCategoryController extends BaseController {
	...
	{
		return View::make('admin_pro.forms_category.index')
	...
	{
		return View::make('admin_pro.forms_category.create');
	}
	...
	public function store()
	{
		...
		if ($validation->passes())
		{
			...
			return Redirect::route('pro-admin.forms-category.edit', $category->id);
		}
	...
	{
		return View::make('admin_pro.forms_category.edit')->with('category', FormCategory::find($id));
	}

...
class ContactsController extends BaseController {
	...
	{
		return View::make('admin_pro.contacts.index')
	...
	{
		return View::make('admin_pro.contacts.create');
	}
	...
	public function store()
	{
		...
		if ($validation->passes())
		{
			...
			return Redirect::route('pro-admin.contacts.edit', $contact->id);
		}
	...
	{
		return View::make('admin_pro.contacts.edit')->with('contact', Contact::find($id));
	}

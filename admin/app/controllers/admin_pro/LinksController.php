...
class LinksController extends BaseController {
	...
	{
		return View::make('admin_pro.links.index')
	...
	{
		return View::make('admin_pro.links.create');
	}
	...
	public function store()
	{
		...
		if ($validation->passes())
		{
			...
			return Redirect::route('pro-admin.links.edit', $link->id);
		}
	...
	{
		return View::make('admin_pro.links.edit')->with('link', Link::find($id));
	}

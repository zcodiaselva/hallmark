...
class PagesController extends BaseController {
	...
	{
		return \View::make('admin_pro.pages.index')
	...
	{
		return \View::make('admin_pro.pages.create')
			->with('category_options', Category::where('site', 'pro')->lists('name', 'id'));
	}
	...
	public function store()
	{
		...
		if ($validation->passes())
		{
			...
			return Redirect::route('pro-admin.pages.edit', $page->id);
		}
	...
	{
		return \View::make('admin_pro.pages.edit')->with('page', Page::with('category')->find($id));
	}
	...
	public function update($id)
	{
		...
		if ($validation->passes())
		{
			...
			if (Input::hasFile('image1'))
			{
				...
				$file->move('uploads/pro/page', $file->getClientOriginalName());

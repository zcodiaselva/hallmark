...
class SlidersController extends BaseController {
	...
	{
		return View::make('admin_pro.sliders.index')
	...
	{
		return View::make('admin_pro.sliders.create');
	}
	...
	public function store()
	{
		...
		if ($validation->passes())
		{
			...
			if (Input::hasFile('image'))
			{
				...
				$file->move('uploads/pro/slider', $file->getClientOriginalName());
			...
			return Redirect::route('pro-admin.sliders.edit', $slider->id);
		}
	...
	{
		return View::make('admin_pro.sliders.edit')->with('slider', Slider::find($id));
	}

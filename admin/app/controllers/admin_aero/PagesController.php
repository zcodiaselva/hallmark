...
class PagesController extends BaseController {
	...
	{
		return \View::make('admin_aero.pages.index')
	...
	{
		return \View::make('admin_aero.pages.create')
			->with('category_options', Category::where('site', 'aero')->lists('name', 'id'));
	}
	...
	public function store()
	{
		...
		if ($validation->passes())
		{
			...
			return Redirect::route('aero-admin.pages.edit', $page->id);
		}
	...
	{
		return \View::make('admin_aero.pages.edit')->with('page', Page::with('category')->find($id));
	}
	...
	public function update($id)
	{
		...
		if ($validation->passes())
		{
			...
			if (Input::hasFile('image1'))
			{
				...
				$file->move('uploads/aero/page', $file->getClientOriginalName());

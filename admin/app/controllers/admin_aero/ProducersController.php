...
class ProducersController extends BaseController {
	...
	{
		return View::make('admin_aero.producers.index')
	...
	{
		return View::make('admin_aero.producers.create');
	}
	...
	public function store()
	{
		...
		if ($validation->passes())
		{
			...
			return Redirect::route('aero-admin.producers.edit', $user->id);
		}
	...
	{
		return View::make('admin_aero.producers.edit')->with('producer', Producer::find($id));
	}

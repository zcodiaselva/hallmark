...
class ProducersController extends BaseController {
	...
	{
		return View::make('admin_es.producers.index')
	...
	{
		return View::make('admin_es.producers.create');
	}
	...
	public function store()
	{
		...
		if ($validation->passes())
		{
			...
			return Redirect::route('es-admin.producers.edit', $user->id);
		}
	...
	{
		return View::make('admin_es.producers.edit')->with('producer', Producer::find($id));
	}

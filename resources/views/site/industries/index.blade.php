          ...
          <div class="panel-group why-choose-group" id="accordion">
            ...
            <div class="panel panel-default">
              <div class="panel-heading">
                <h4 class="panel-title"> <a data-toggle="collapse" data-parent="#accordion" href="#collapse<?=$i?>"> {{$class->name}} <span class="fa  <?php if($i==1){?>fa-chevron-down<?php }else{ ?>fa-chevron-down<?php }?>"></span> </a> </h4>
              </div>
              <?php if ($i==1){ ?>

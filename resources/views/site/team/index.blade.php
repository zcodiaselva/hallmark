     ...
     <div class="row">
        <div class="col-sm-12">
          <div class="panel-group why-choose-group" id="accordion">
              <?php $i = 0; ?>
               @foreach ($classes as $staff) 
               <?php $i = $i+1; ?>
            <div class="panel panel-default">
              <div class="panel-heading">
                <h4 class="panel-title"> <a data-toggle="collapse" data-parent="#accordion" href="#collapse<?=$i?>"> {{ $staff->name}} <span class="fa <?php if($i==1){?>fa-chevron-down<?php }else{ ?>fa-chevron-down<?php }?>"></span> </a> 
